...
class EDD_GIT_Download_Updater_Ajax
{
    ...
    public function ajax_fetch_file( $file ) {
        ...
        echo json_encode( array( 'file' => $new_zip['url'], 'sl_version' => $this->instance->sl_version, 'changelog' => $this->instance->changelog, 'errors' => $this->instance->errors, 'name' => $file_name ) );
        die();
    }
    ...
    public function gh_set_oauth_key() {
        ...
        if ( isset( $_GET['code'] ) ) {
            ...
            $redirect = admin_url( 'edit.php?post_type=download&page=edd-settings&tab=extensions&section=edd-git' );
